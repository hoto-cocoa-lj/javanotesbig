 ...
 * 
 */
@WebServiceClient(name = "UserServiceImplService", targetNamespace = "http://service.itcast.cn/", wsdlLocation = "http://localhost:8080/cxfservice/ws/user?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/cxfservice/ws/user?wsdl");
