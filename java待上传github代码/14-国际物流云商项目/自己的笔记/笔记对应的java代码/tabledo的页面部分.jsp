...
<script language="JavaScript">
	...
	function addTRRecord(objId, id, productNo, cnumber, grossWeight, netWeight, sizeLength, sizeWidth, sizeHeight, exPrice, tax) {
		...
		oTD.innerHTML = "<input class=\"input\" type=\"checkbox\" name=\"del\" value=\""+id+"\"><input type=\"hidden\" name=\"mr.mr_id\" value=\""+id+"\"><input class=\"input\" type=\"hidden\" id=\"mr_changed\" value=\"0\" name=\"mr.mr_changed\">";
		...
		oTD.innerHTML = "<input type=\"text\" name=\"mr.mr_cnumber\" maxLength=\"10\" value=\""+cnumber+"\" onchange=\"setUpdate(this);\" size=\"15\">";
		oTD = oTR.insertCell(5);
		oTD.innerHTML = "<input type=\"text\" name=\"mr.mr_grossWeight\" maxLength=\"10\" value=\""+grossWeight+"\" onchange=\"setUpdate(this);\" size=\"15\">";
		oTD = oTR.insertCell(6);
		oTD.innerHTML = "<input type=\"text\" name=\"mr.mr_netWeight\" maxLength=\"10\" value=\""+netWeight+"\" onchange=\"setUpdate(this);\" size=\"15\">";
		oTD = oTR.insertCell(7);
		oTD.innerHTML = "<input type=\"text\" name=\"mr.mr_sizeLength\" maxLength=\"10\" value=\""+sizeLength+"\" onchange=\"setUpdate(this);\" size=\"15\">";
		oTD = oTR.insertCell(8);
		oTD.innerHTML = "<input type=\"text\" name=\"mr.mr_sizeWidth\" maxLength=\"10\" value=\""+sizeWidth+"\" onchange=\"setUpdate(this);\" size=\"15\">";
		oTD = oTR.insertCell(9);
		oTD.innerHTML = "<input type=\"text\" name=\"mr.mr_sizeHeight\" maxLength=\"10\" value=\""+sizeHeight+"\" onchange=\"setUpdate(this);\" size=\"15\">";
		oTD = oTR.insertCell(10);
		oTD.innerHTML = "<input type=\"text\" name=\"mr.mr_exPrice\" maxLength=\"10\" value=\""+exPrice+"\" onchange=\"setUpdate(this);\" size=\"15\">";
		oTD = oTR.insertCell(11);
		oTD.innerHTML = "<input type=\"text\" name=\"mr.mr_tax\" maxLength=\"10\" value=\""+tax+"\" onchange=\"setUpdate(this);\" size=\"15\">";
...
<body>
<a href='${ctx}/cargo/exportAction_getTabledoData.action'>123</a>
