 ...
 */
public class Page<T> {
	private String fuck="test f you";
	...
	public String getLinks() {
		...
		sBuf.append("\n\t function gogo(url,i){");
		sBuf.append("uuu=url+"+"'?page.pageNo='+"+"i;");
		sBuf.append("alert('uuu='+uuu);");
		sBuf.append("window.location.href=uuu;");
		sBuf.append("	}");
		
		sBuf.append("</script>");
		sBuf.append("<input type=\"hidden\" id=\"page.pageNo\" name=\"page.pageNo\" value=\"")
			.append(curPageNo).append("\">");		//分页参数：当前页隐藏域
		...
		sBuf.append("<a href=\"#").append("\" onclick=\"gogo('"+url+"',"+curPageNo+")\">[test]");
		sBuf.append("</a>&nbsp;");
