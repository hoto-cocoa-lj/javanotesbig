...
//		return "login";
		...
		Md5Hash p2 = new Md5Hash(password, username, 2);
		UsernamePasswordToken arg0 = new UsernamePasswordToken(username,p2.toString());
		System.out.println("loginaction arg0="+arg0);
		try {
			sj.login(arg0);
			session.put(SysConstant.CURRENT_USER_INFO,(User)sj.getPrincipal());
			return SUCCESS;
		} catch (Exception e) {
			super.put("errorInfo","登录失败");
			return "login";
		}
	}
