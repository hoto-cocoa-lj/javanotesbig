...
public class MailUtil {
	...
	public static void sendMsg(String to ,String subject ,String content) throws Exception{
		...
		//4.设置消息的发送者
		Address fromAddr = new InternetAddress("17136413603@163.com");
		...
		message.setRecipient(RecipientType.CC,fromAddr);
		...
		//9.设置火箭的发射目标 
		transport.connect("smtp.163.com", "17136413603@163.com", "qq17136413603");
		//10.发送
