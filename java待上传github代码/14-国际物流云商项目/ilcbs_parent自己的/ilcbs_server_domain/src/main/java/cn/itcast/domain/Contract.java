...
public class Contract extends BaseEntity {
	...
	@Column(name="FUCK")
	private Integer fuck;//状态
	public Integer getFuck() {
//		if(fuck==null||fuck<=0){
//			int f=0;
//			Set<ContractProduct> ss = getContractProducts();
//			for(ContractProduct s:ss){
//				f+=s.getExtCproducts().size();
//			}
//			setFuck(f);
//		}
		return fuck;
	}
	public void setFuck(Integer fuck) {
		this.fuck = fuck;
	}
	public String getId() {
		return id;
	...
	public void setOfferor(String offer) {
		this.offeror = offer;
	}
