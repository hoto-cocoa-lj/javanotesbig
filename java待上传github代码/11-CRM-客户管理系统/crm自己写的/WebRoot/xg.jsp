...
<a href="javascript:void(0)" id="aaa">aaa</a>
   <form action="${pageContext.request.contextPath}/customer_xg.action" method="post">
<input type=hidden name='cust_id' value='<s:property value="c1.cust_id"/>'/><br>
   	客户名称<input type=text name='cust_name' value='<s:property value="c1.cust_name"/>'/><br>
   	固定电话<input type=text name='cust_phone' value='<s:property value="c1.cust_phone"/>' /><br>
   	移动电话<input type=text name='cust_mobile' value='<s:property value="c1.cust_mobile"/>' /><br>
   	客户信息来源
