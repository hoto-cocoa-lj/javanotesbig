...
//用来解决service层类似于CatoService cs = new CatoServiceImpl()代码的解耦合，比如CatoServiceImpl是操作mysql的类，
//那么更换数据库时需要更改service层的代码。使用BeanFactory和appication.xml可以解决这个问题
